...
jar_diameter_middle = 115.0  # mm, slightly wider at the base
jar_diameter_bottom = 100.0 
jar_height = 235.0  # mm, total height
jar_thread_height = 225.0
jar_middle_height = 180.0
jar_bottom_height = 20.0
jar_wall_thickness = 3.0  # mm
lid_thread_diameter = 115.0  # mm, outer thread diameter
